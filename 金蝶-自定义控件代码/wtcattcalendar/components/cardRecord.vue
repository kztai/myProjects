        ...
        'wtc-card-record-dot-future': cardRecord.workCardTime === ''}"></div>
            ...
            <div class="wtc-homePage-calendar-card-record-detail">
              ...
              'wtc-card-record-status-danger': cardRecord.workCardStatus === '1030_S' || cardRecord.workCardStatus === '1040_S'
                ...
                <button class="wtc-homePage-calendar-card-record-detail-right"
                    v-show="cardRecord.workCardStatus && cardRecord.workCardStatus != 0 && showDealBtn"
                    @click="dealAbnormal('on')">
                    {{KDApi.getLangMsg(model, 'deal')}}
                </button>
            </div>
        </div>
...
<script>
    export default {
        name: "cardRecord1",
        props: ["cardRecord", "num", 'model', 'KDApi', 'showDealBtn', 'cardType', 'dateIndex'],
        data() {
            return {};
        },
        ...
        methods: {
            dealAbnormal(type) {
                this.$emit('dealClick', this.num, type, this.dateIndex);
            },
            getStatus(type) {
...
<style scoped>
    ...
    .wtc-homePage-calendar-card-record-on,
    .wtc-homePage-calendar-card-record-off {
        padding: 5px 0;
    }
