<template>
    <div class="wtc_roster-simple-table-plan-actual-group-list-wrap">
        <div class="wtc_roster-simple-table-slide-line" @mousedown="slideStart"></div>

        <ul class="wtc_roster-simple-table-plan-actual-group-list">
            <li class="wtc_roster-simple-table-plan-actual-group-item"
                v-for="(orgRosterData, index) in orgShiftModelList" :key="index" :groupid="orgRosterData.id">
                <div class="wtc_roster-simple-table-plan-actual-group-row"></div>
                <ul class="wtc_roster-simple-table-plan-actual-list">
                    <li class="wtc_roster-simple-table-plan-actual-item"
                        v-for="(orgRosterData, index1) in rosterShiftModelList[index]" :key="index1">
                        <div class="wtc_roster-simple-table-right-plan-text"
                            v-show="showType === 'SHOW_ALL' || showType === 'SHOW_PLAN'">计划</div>
                        <div class="wtc_roster-simple-table-right-actual-text"
...
<script>
    export default {
        name: "planActualSpanOrg",

        props: ['orgShiftModelList', 'showType'],
        inject: ['model', 'KDApi'],
...
<style scoped>
    .wtc_roster-simple-table-plan-actual-group-list-wrap {
        position: relative;
    ...
    .wtc_roster-simple-table-plan-actual-group-list .wtc_roster-simple-table-plan-actual-group-row {
        height: 30px;
    ...
    .wtc_roster-simple-table-plan-actual-list {
        /*overflow: hidden;*/
        /*max-height: 100px;*/
    }

    .wtc_roster-simple-table-plan-actual-group-list .wtc_roster-simple-table-plan-actual-item {
        display: flex;
    ...
    .wtc_roster-simple-table-plan-actual-group-list .wtc_roster-simple-table-plan-actual-item div {
        flex: 1;
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    .wtc_roster-simple-table-plan-actual-group-list .wtc_roster-simple-table-plan-actual-item .wtc_roster-simple-table-right-actual-text {
        border-bottom: 1px solid #D9D9D9;
    }
</style>