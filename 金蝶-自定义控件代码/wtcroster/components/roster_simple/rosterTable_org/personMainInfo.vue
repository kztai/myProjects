<template>
    <ul class="wtc_roster-simple-table-content-left-group-list">
        <li class="wtc_roster-simple-table-content-left-group-item" v-for="(orgRosterData, index) in orgShiftModelList"
            :key="index" @mousedown="rowCellActive($event, index)" :groupid="orgRosterData.id">
            <div class="wtc_roster-simple-table-content-left-group-row"
                @click="togglePersonRoster(orgRosterData.id, index)">
                <i class="wtc_roster-simple-table-content-group-row-icon kdfont"
            ...
            <ul @mousedown.stop class="wtc_roster-simple-table-left-person-list">
                <li class="wtc_roster-simple-table-left-person-item"
                    v-for="(rosterData, index1) in rosterShiftModelList[index]" :key="index1"
                    :personId="rosterData.rosterPerson.id">
                    <div class="wtc_roster-simple-table-left-person-img">
                        <img :src="rosterData.rosterPerson.img || imgUrl_person" alt="" width="28" height="28">
                    </div>
                    <div class="wtc_roster-simple-table-left-person-msg">
                        <div class="wtc_roster-simple-table-left-person-msg-top">
                            ...
                            <div class="wtc_roster-simple-table-left-person-top-number">{{
                                rosterData.rosterPerson.number }}
                            </div>
                            <!--<div class="wtc_roster-simple-table-left-person-top-log">{{ langText_log }}</div>-->
                        </div>
                        <div class="wtc_roster-simple-table-left-person-msg-bottom">
                            <div class="wtc_roster-simple-table-left-person-bottom-left">
                                <i class="kdfont kdfont-gongzuori2" title="工作日天数"></i>
                                <span class="wtc_roster-simple-table-left-person-bottom-left-num1">{{
                                    rosterData.rosterPerson.workDay }}</span>
                            </div>
                            <div class="wtc_roster-simple-table-left-person-bottom-left">
                                <i class="kdfont kdfont-xiuxiri" title="休息日天数"></i>
                                <span class="wtc_roster-simple-table-left-person-bottom-left-num2">{{
                                    rosterData.rosterPerson.restDay }}</span>
                            </div>
                            <div class="wtc_roster-simple-table-left-person-bottom-left">
                                <i class="kdfont kdfont-jiaqi2" title="节假日天数"></i>
                                <span class="wtc_roster-simple-table-left-person-bottom-left-num3">{{
...
<style scoped>
    ...
    .wtc_roster-simple-table-content-left-group-list .wtc_roster-simple-table-content-left-group-item {}

    .wtc_roster-simple-table-content-left-group-item .wtc_roster-simple-table-content-left-group-row {
        height: 30px;
        line-height: 30px;
        padding: 0 10px;
        box-sizing: border-box;
    ...
    .wtc_roster-simple-table-content-left-group-item .wtc_roster-simple-table-content-left-group-row>i {
        font-size: 14px;
        margin-right: 4px;
    }

    .wtc_roster-simple-table .wtc_roster-simple-table-left-person-list {
        /*max-height: 100px;*/
        /*overflow: hidden;*/
    }

    .wtc_roster-simple-table .wtc_roster-simple-table-left-person-item {
        display: flex;
        border-bottom: 1px solid #D9D9D9;
        border-right: 1px solid #D9D9D9;
        text-align: center;
    ...
    .wtc_roster-simple-table .wtc_roster-simple-table-left-person-item .wtc_roster-simple-table-left-person-img {
        flex: 0 0 28px;
        width: 28px;
        height: 28px;
        border-radius: 50%;
    ...
    .wtc_roster-simple-table .wtc_roster-simple-table-left-person-item .wtc_roster-simple-table-left-person-msg {
        flex: 1;
        margin-left: 10px;
        width: 170px
    }

    .wtc_roster-simple-table-left-person-msg .wtc_roster-simple-table-left-person-msg-top {
        display: flex;
        margin-bottom: 10px;
        box-sizing: border-box;
        width: 100%;
    ...
    .wtc_roster-simple-table-left-person-msg .wtc_roster-simple-table-left-person-msg-top>p {
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
        font-size: 14px;
    ...
    .wtc_roster-simple-table-left-person-msg .wtc_roster-simple-table-left-person-msg-top .wtc_roster-simple-table-left-person-top-number {
        margin: 2px 0 0 8px;
        color: #666;
        font-size: 12px;
        white-space: nowrap;
    ...
    /*.wtc_roster-simple-table-left-person-msg .wtc_roster-simple-table-left-person-msg-top .wtc_roster-simple-table-left-person-top-log {*/
    /*display: none;*/
    /*flex: 1;*/
    /*text-align: right;*/
    /*color: var(--themeColor, #276FF5);*/
    ...
    .wtc_roster-simple-table-left-person-msg .wtc_roster-simple-table-left-person-msg-bottom {
        display: flex;
        justify-content: space-between;
    }

    .wtc_roster-simple-table-left-person-msg .wtc_roster-simple-table-left-person-msg-bottom div {
        padding-right: 2px;
    }

    .wtc_roster-simple-table-left-person-msg .wtc_roster-simple-table-left-person-msg-bottom div i {
        color: #8590A6;
        font-size: 14px;
        margin-right: 8px;
    }

    .wtc_roster-simple-table-left-person-msg .wtc_roster-simple-table-left-person-msg-bottom div span {
        color: #333;
        font-size: 14px;
        font-weight: 700;
    }
