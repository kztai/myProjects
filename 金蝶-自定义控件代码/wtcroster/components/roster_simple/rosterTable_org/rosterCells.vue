<template>
    <ul ref="rightGroupList" class="wtc_roster-simple-table-right-group-list" :style="{'width': rightWidth}">
        <li class="wtc_roster-simple-table-right-group-item"
            ...
            <ul class="wtc_roster-simple-table-right-data-list">
                <li class="wtc_roster-simple-table-right-data-item"
                    v-for="(rosterData, index) in rosterShiftModelList[index3]" :key="index"
                    ...
                    <ul class="wtc_roster-simple-table-right-plan-list"
                        ...
                        <cell class="wtc_roster-simple-table-right-plan-roster-wrap"
                    ...
                    <ul class="wtc_roster-simple-table-right-actual-list"
                        ...
                        <cell class="wtc_roster-simple-table-right-actual-roster-wrap"
