<template>
    <ul ref="rightGroupList" class="wtc_roster-table-right-group-list" :style="{'width': rightWidth}">
        <li ref="dataItem" class="wtc_roster-table-right-data-item"
            ...
            <ul class="wtc_roster-table-right-plan-list"
                ...
                <cell @showRightClickMenu="showRightClickMenu" @shiftActiveCells="shiftActiveCells"
                    @cancelAllActive="cancelAllActive" ref="cells" class="wtc_roster-table-right-plan-roster-wrap"
            ...
            <ul class="wtc_roster-table-right-actual-list"
                ...
                <cell @showRightClickMenu="showRightClickMenu" @shiftActiveCells="shiftActiveCells"
                    @cancelAllActive="cancelAllActive" ref="cells" class="wtc_roster-table-right-actual-roster-wrap"
                        ...
                        for (let i = 0; i < $this.arrInsertShift.length; i++) {
                            if ($this.arrInsertShift[i].id === shiftId && $this.arrInsertShift[i].shiftEntryList) {
                                ...
                                for (let n = 0; n < $this.arrInsertShift[i].shiftEntryList.length; n++) {
                                    ...
                                    str += `
                            <div class="wtc_roster-table-shift-detail-time-item" style="margin-bottom: 6px;white-space: nowrap;">${outWorkType}：${objShiftEntry.shiftStartDateStr} ~ ${objShiftEntry.shiftEndDateStr}（${objShiftEntry.workTime}h）</div>
                        `;
                                }
