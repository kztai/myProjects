<template>
    <div class="wtc_roster-table-plan-actual-group-list-wrap">
        ...
        <ul class="wtc_roster-table-plan-actual-group-list">
            <li class="wtc_roster-table-plan-actual-group-item" v-for="(orgRosterData, index) in orgShiftModelList"
                :key="index" :groupid="orgRosterData.id">
                <div class="wtc_roster-table-plan-actual-group-row"></div>
                <ul class="wtc_roster-table-plan-actual-list">
                    <li class="wtc_roster-table-plan-actual-item"
