<template>
    <div class="wtc_roster-table-total-wrap">
        <div class="wtc_roster-table-total-list">
            <ul class="wtc_roster-table-total-list-wrap">
                <li class="wtc_roster-table-total-both wtc_roster-table-total-time">
                    <div class="wtc_roster-table-total-both-top">
                        <span class="wtc_roster-table-total-left-text"
                            v-show="showType === 'SHOW_ALL' || showType === 'SHOW_PLAN'">{{langText_planTime}}</span>
                        <span class="wtc_roster-table-total-left-text" v-show="showType === 'SHOW_ALL'">(</span>
                        <span class="wtc_roster-table-total-left-text"
                            v-show="showType === 'SHOW_ALL' || showType === 'SHOW_REAL'">{{langText_actualTime}}</span>
                        <span class="wtc_roster-table-total-left-text" v-show="showType === 'SHOW_ALL'">)</span>
                    </div>
                    <div class="wtc_roster-table-total-both-bottom">
                        <span class="wtc_roster-table-total-left-text"
                            v-show="showType === 'SHOW_ALL' || showType === 'SHOW_PLAN'">{{ rosterSum.planRosterSumTime
                            }}</span>
                        <span class="wtc_roster-table-total-left-text" v-show="showType === 'SHOW_ALL'">(</span>
                        <span class="wtc_roster-table-total-left-text" style="color: #FA3232;"
                            v-show="showType === 'SHOW_ALL' || showType === 'SHOW_REAL'">{{ rosterSum.realRosterSumTime
                            }}</span>
                        <span class="wtc_roster-table-total-left-text" v-show="showType === 'SHOW_ALL'">)</span>
                    </div>
                </li>
                <li class="wtc_roster-table-total-both wtc_roster-table-total-num" v-if="rosterview === 'tabperson'">
                    <div class="wtc_roster-table-total-both-top">
                        <span class="wtc_roster-table-total-left-text"
        ...
        <div class="wtc_roster-table-total-middle-wrap" :style="{'width': middleWidth}"></div>

        <div class="wtc_roster-table-total-plan-actual"></div>

        <div ref="totalContent" class="wtc_roster-table-total-content-wrap" :style="{'width': rightWidth}">
            <ul class="wtc_roster-table-total-content">
                <li class="wtc_roster-table-total-content-item"
                    v-for="(objSummary, index) in rosterSum.rosterSummaryList" :key="index">
                    <div class="wtc_roster-table-total-content-item-time"
                    ...
                    <div class="wtc_roster-table-total-content-item-num" v-if="rosterview === 'tabperson'"
...
<style scoped>
    ...
    .wtc_roster-table-total-wrap .wtc_roster-table-total-list {
    ...
    .wtc_roster-table-total-list-wrap {
        display: flex;
    ...
    .wtc_roster-table-total-list .wtc_roster-table-total-both {
        /*display: flex;*/
        /*justify-content: center;*/
        /*align-items: center;*/
        height: 34px;
    ...
    .wtc_roster-table-total-both-bottom {
        margin-top: -2px;
    }

    .wtc_roster-table-total-list .wtc_roster-table-total-both .wtc_roster-table-total-left-text {
        color: #666;
        font-size: 12px;
        white-space: nowrap;
    }

    .wtc_roster-table-total-list .wtc_roster-table-total-both-num {
        margin-left: 4px;
    }

    .wtc_roster-table-total-wrap .wtc_roster-table-total-middle-wrap {
        display: inline-block;
        vertical-align: top;
        font-size: 14px;
        width: 0px;
    ...
    .wtc_roster-table-total-wrap .wtc_roster-table-total-plan-actual {
        display: inline-block;
        vertical-align: top;
        width: 40px;
        font-size: 12px;
    ...
    .wtc_roster-table-total-wrap .wtc_roster-table-total-content-wrap {
        display: inline-block;
        vertical-align: top;
        font-size: 14px;
        height: 100%;
    ...
    .wtc_roster-table-total-content {
        display: flex;
        box-sizing: border-box;
        height: 68px;
    }

    .wtc_roster-table-total-content-item {
        display: flex;
        flex-direction: column;
        justify-content: center;
        flex: 1;
    ...
    .wtc_roster-table-total-content-item>div {
        height: 34px;
        line-height: 34px;
        text-align: center;
        overflow: hidden;
    ...
    .wtc_roster-table-total-content-item>div>span {
        font-size: 12px;
    }
</style>